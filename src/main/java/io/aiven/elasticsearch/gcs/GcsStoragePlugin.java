...
public class GcsStoragePlugin extends Plugin implements RepositoryPlugin, ReloadablePlugin {

    private static final Logger LOGGER = LoggerFactory.getLogger(GcsStoragePlugin.class);

    private final GcsSettingsProvider gcsSettingsProvider;

    public GcsStoragePlugin(final Settings settings) {
    ...
    public void reload(final Settings settings) {
        try {
            ...
            LOGGER.error("Couldn't initialize GCS provider", e);
        }
    }
